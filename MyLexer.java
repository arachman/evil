// $ANTLR 2.7.7 (20070330): "evil.g" -> "MyLexer.java"$
...
public class MyLexer extends antlr.CharScanner implements MyLexerTokenTypes, TokenStream
 {
...
public MyLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("read", this), new Integer(9));
	literals.put(new ANTLRHashString("false", this), new Integer(17));
	literals.put(new ANTLRHashString("print", this), new Integer(8));
	literals.put(new ANTLRHashString("true", this), new Integer(16));
	literals.put(new ANTLRHashString("void", this), new Integer(18));
	literals.put(new ANTLRHashString("endl", this), new Integer(19));
	literals.put(new ANTLRHashString("fun", this), new Integer(5));
	literals.put(new ANTLRHashString("null", this), new Integer(15));
	literals.put(new ANTLRHashString("bool", this), new Integer(14));
	literals.put(new ANTLRHashString("while", this), new Integer(6));
	literals.put(new ANTLRHashString("new", this), new Integer(4));
	literals.put(new ANTLRHashString("return", this), new Integer(7));
...
tryAgain:
	...
	public final void mCOMPAR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = COMPAR;
		int _saveIndex;
	...
	public final void mCOMM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = COMM;
		int _saveIndex;
